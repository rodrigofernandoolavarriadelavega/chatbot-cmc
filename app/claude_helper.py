...
_INTENT_CACHE: dict[str, dict] = {
    ...
    # Grafía sin p (válida en RAE y frecuente en WhatsApp rural) + typos
    # (caso real 2026-08-06: "siquiatra" caía a medicina general)
    "siquiatra":      {"intent": "agendar", "especialidad": "psiquiatría"},
    "siquiatría":     {"intent": "agendar", "especialidad": "psiquiatría"},
    "siquiatria":     {"intent": "agendar", "especialidad": "psiquiatría"},
    "sikiatra":       {"intent": "agendar", "especialidad": "psiquiatría"},
    "psquiatra":      {"intent": "agendar", "especialidad": "psiquiatría"},
    "psiquatra":      {"intent": "agendar", "especialidad": "psiquiatría"},
    "sicologo":       {"intent": "agendar", "especialidad": "psicología"},
    "sicólogo":       {"intent": "agendar", "especialidad": "psicología"},
    "sicologa":       {"intent": "agendar", "especialidad": "psicología"},
    "sicóloga":       {"intent": "agendar", "especialidad": "psicología"},
    "sicologia":      {"intent": "agendar", "especialidad": "psicología"},
    "sicología":      {"intent": "agendar", "especialidad": "psicología"},
    ...
    # FIX 5a (2026-06-10): avisos de atraso — no derivar a humano, responder directamente.
    "llego tarde":             {"intent": "aviso_atraso", "especialidad": None},
    "llegaré tarde":           {"intent": "aviso_atraso", "especialidad": None},
    "llegare tarde":           {"intent": "aviso_atraso", "especialidad": None},
    "voy atrasado":            {"intent": "aviso_atraso", "especialidad": None},
    "voy atrasada":            {"intent": "aviso_atraso", "especialidad": None},
    "voy en camino":           {"intent": "aviso_atraso", "especialidad": None},
    "me atrasé":               {"intent": "aviso_atraso", "especialidad": None},
    "me atrase":               {"intent": "aviso_atraso", "especialidad": None},
    "me demoré":               {"intent": "aviso_atraso", "especialidad": None},
    "me demore":               {"intent": "aviso_atraso", "especialidad": None},
    "llegaré con retraso":     {"intent": "aviso_atraso", "especialidad": None},
    "llegare con retraso":     {"intent": "aviso_atraso", "especialidad": None},
    "voy demorado":            {"intent": "aviso_atraso", "especialidad": None},
    "voy demorada":            {"intent": "aviso_atraso", "especialidad": None},
