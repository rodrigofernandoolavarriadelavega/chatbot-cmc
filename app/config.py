...
ALMA_PROFILES: dict[str, dict] = {
    ...
    "cmc_admin_2026": {
        "variante": "Recepción",
        "modulos": ["inicio", "panel", "panel2", "agenda", "pagos", "inventario", "proveedores", "pacientes", "interconsultas", "esterilizacion", "documentos", "examenes", "tareas", "calidad", "ortodoncia", "boxes", "autopilot"],  # recepción
