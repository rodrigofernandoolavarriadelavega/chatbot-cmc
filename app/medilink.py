...
PROFESIONALES = {
    ...
    78: {"nombre": "Dra. Cecilia Unibazo",     "especialidad": "Psiquiatría",           "intervalo": 60, "dias": [3]},
}
...
def _filtrar_licencia(ids: list) -> list:
    ...
    try:
        ...
        log.warning("medilink._filtrar_licencia fallo (no filtra): %s", e)
        return ids
