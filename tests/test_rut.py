...
CASES: list[tuple] = [
    ...
    # ── Comas como separador de miles (consolidado 2026-08-24, #3) ──
    ("COMA-01", "28,027,007-5",      "28027007-5", True),
    ("COMA-02", "10,568,006-6",      "10568006-6", True),
    ("COMA-03", "12,345,678-5",      "12345678-5", True),
]
